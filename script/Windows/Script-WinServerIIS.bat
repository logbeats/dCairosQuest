...
IF ERRORLEVEL 1 echo IISlnk,0 >> ExtractResult.csv
IF NOT ERRORLEVEL 1 echo IISlnk,1 >> ExtractResult.csv
del lnk.txt

cacls C:\Inetpub\wwwroot > Home-Acl.txt
type Home-Acl.txt | findstr /I "everyone" > nul
IF ERRORLEVEL 1 echo EveryoneAcl,0 >> ExtractResult.csv
IF NOT ERRORLEVEL 1 echo EveryoneAcl,1 >> ExtractResult.csv

type Home-Acl.txt | findstr /I "Users:(ID)F" > nul
IF ERRORLEVEL 1 echo UserseAcl,0 >> ExtractResult.csv
IF NOT ERRORLEVEL 1 echo UserseAcl,1 >> ExtractResult.csv

type Home-Acl.txt | findstr /I "IUSR_" > nul
IF ERRORLEVEL 1 echo IUSR_Acl,0 >> ExtractResult.csv
IF NOT ERRORLEVEL 1 echo IUSR_Acl,1 >> ExtractResult.csv
del Home-Acl.txt
...
:CONFIG-ABSENCE
echo checkISAPI,0 >> ExtractResult.csv
del checkISAPI.txt
goto QUIT
:CONFIG-PRESENCE
type checkISAPI.txt | findstr /I "false" > nul
IF ERRORLEVEL 1 echo checkISAPI,0 >> ExtractResult.csv
IF NOT ERRORLEVEL 1 echo checkISAPI,1 >> ExtractResult.csv
del checkISAPI.txt
:QUIT
...
IF NOT ERRORLEVEL 1 GOTO CONFIG-PRESENCE
:CONFIG-ABSENCE
echo checkCGI,0 >> ExtractResult.csv
del checkCGI.txt
goto QUIT
:CONFIG-PRESENCE
type checkCGI.txt | findstr /I "false" > nul
IF ERRORLEVEL 1 echo checkCGI,0 >> ExtractResult.csv
IF NOT ERRORLEVEL 1 echo checkCGI,1 >> ExtractResult.csv
del checkCGI.txt
:QUIT

type applicationHost.config | findstr /I "directoryBrowse enabled" > DirBrowse.txt 
type DirBrowse.txt | find "true" > nul
IF ERRORLEVEL 1 ECHO DirBrowse,0 >> ExtractResult.csv
IF NOT ERRORLEVEL 1 ECHO DirBrowse,1 >> ExtractResult.csv
del DirBrowse.txt 

type applicationHost.config  | findstr /I "enableParentPaths" > ParentPaths.txt 
type ParentPaths.txt | find "true" > nul
IF ERRORLEVEL 1 ECHO ParentPaths,0 >> ExtractResult.csv
IF NOT ERRORLEVEL 1 ECHO ParentPaths,1 >> ExtractResult.csv 
del ParentPaths.txt

type Metabase.xml | findstr /I "AspEnableParentPaths" > AspEnableParentPaths.txt
type AspEnableParentPaths.txt | find "true" > nul
IF ERRORLEVEL 1 ECHO AspEnableParentPaths,0 >> ExtractResult.csv
IF NOT ERRORLEVEL 1 ECHO AspEnableParentPaths,1 >> ExtractResult.csv
del AspEnableParentPaths.txt 

type Metabase.xml | findstr /I "ip security" > IPsecurity.txt
IF ERRORLEVEL 1 echo IPsecurity,0 >> ExtractResult.csv
IF NOT ERRORLEVEL 1 ECHO IPsecurity,1 >> ExtractResult.csv
del IPsecurity.txt
...
IF ERRORLEVEL 1 echo identityType,0 >> ExtractResult.csv
IF NOT ERRORLEVEL 1 ECHO identityType,1 >> ExtractResult.csv
